...
export function calculateScoreFromData(input: {
  matchPredictions: Record<string, SavedPick | undefined>
  knockoutPredictions: Record<string, SavedPick | undefined>
  groupPredictions: Record<string, string[] | undefined>
