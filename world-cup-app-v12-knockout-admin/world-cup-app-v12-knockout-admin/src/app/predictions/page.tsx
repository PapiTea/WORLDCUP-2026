        ...
        <Tabs defaultValue="group" className="space-y-6">
          <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            <TabsList className="h-12 rounded-2xl bg-muted/70 p-1">
              <TabsTrigger value="group" className="rounded-xl px-5 font-black data-[state=active]:bg-primary data-[state=active]:text-primary-foreground">
                Group Stage
              </TabsTrigger>
              <TabsTrigger value="knockouts" className="rounded-xl px-5 font-black data-[state=active]:bg-primary data-[state=active]:text-primary-foreground">
                Knockouts
              </TabsTrigger>
            </TabsList>
